...
module.exports = {
  ...
  askWebflowTableReference: async () => {
    const questions = [
      {
        name: 'webflowTableReference',
        type: 'input',
        message: 'Enter your origin webflow collection singular name  (Once you have your API key, you can get a look at your schema if it is not `post-body` https://developers.webflow.com/#list-collections)',
        validate: function(value) {
          if (value.length) {
            return true
          } else {
            return 'Please enter the webflow table reference from your schema `or try post-body`'
          }
        }
      }
    ]
